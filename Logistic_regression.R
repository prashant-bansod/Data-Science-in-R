...
#Combining the Middle and Old levels together
...
plot(data$Salary,data$AmountSpent)# heteroescadasticity
...
#Creating a category called missing
...
#Remidies: Applying log transform to y variable
